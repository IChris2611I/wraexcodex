 ...
 *
 * Same catch-all pattern as sign-in — Clerk needs sub-routes for
 * email verification steps, OAuth callbacks, etc.
 */
...
export const metadata: Metadata = {
  title: "Create Account — Wraex Codex",
  description: "Create your free Wraex Codex account. Save builds, submit guides, and access the Oracle AI build advisor.",
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="mb-8 text-center">
          ...
          <p className="mt-3 font-body text-sm text-parchment-muted">
            Join the Wraeclast Codex — it&apos;s free
          </p>
        </div>
